...
%
% Example:
%   training = importfile('training.csv', 1, 592);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/06/17 10:38:26
...
training = table(dataArray{1:end-1}, 'VariableNames', {'id','sTime','sDist','sHP','sDamage','eTime','eDist','eHP','eDamage'});
